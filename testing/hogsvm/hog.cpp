...
int main( int argc, char** argv )
{
    ...
    load_images("/home/asekulsk/Dokumente/Master/Testcase/INRIA/", "Test/pos.lst", pos_lst );
    labels.assign( pos_lst.size(), +1 );
    const unsigned int old = (unsigned int)labels.size();
    load_images("/home/asekulsk/Dokumente/Master/Testcase/INRIA/", "Test/neg.lst", full_neg_lst );
