...
namespace Companion {
    ...
    namespace Algorithm {
        ...
        /**
         * Shape detection implementation to detect ROI elements.
        ...
        class COMP_EXPORTS ShapeDetection : public ImageRecognition {
            ...
            public:
                /**
                 * Algorithm implementation for shape detection.
                 ...
                 */
                Companion::Model::Result* algo(Companion::Model::Processing::ImageRecognitionModel *searchModel,
                                                       Companion::Model::Processing::ImageRecognitionModel *compareModel);
